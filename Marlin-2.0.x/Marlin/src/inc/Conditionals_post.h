...
#else
  #define WRITE_HEATER_0(v) {static unsigned char heat0_v; if(heat0_v!=v){ heat0_v=v; WRITE_HEATER_0P(v);}}//WRITE_HEATER_0P(v)
#endif
 ...
 */
  ...
  #endif
  #define WRITE_HEATER_BED(v) {static unsigned char bed_v; if(bed_v!=v){ bed_v=v; WRITE(HEATER_BED_PIN, (v) ^ HEATER_BED_INVERTING);}}
#endif
