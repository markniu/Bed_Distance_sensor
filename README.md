...
there is no distance sensor used on the 3D printer for it's high price with this high resoluion for example [IWFK20Z8704](https://www.kempstoncontrols.co.uk/IWFK-20Z8704-S35A/Baumer/sku/239240),all the bed level sensor used now on 3D printer is proximity e.g. the BLTouch.
